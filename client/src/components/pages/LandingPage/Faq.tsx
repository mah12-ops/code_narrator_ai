...
function Faq() {
  ...
  return (
    <section id="faq" className="mx-auto max-w-5xl px-6 sm:px-8 md:px-24 py-12 md:py-24">
          ...
          <div key={f.q} className="bg-black">
            ...
            >
              ...
              <AnimatePresence initial={false}>
                {openFaq === idx ? (
                  <motion.span initial={{ rotate: 0 }} animate={{ rotate: 180 }} exit={{ rotate: 0 }}>
                    <ArrowRight className="h-4 w-4" />
                  </motion.span>
                ) : (
                  <motion.span initial={{ rotate: 180 }} animate={{ rotate: 0 }} exit={{ rotate: 180 }}>
                    <ArrowRight className="h-4 w-4" />
                  </motion.span>
                )}
              </AnimatePresence>
            ...
            <AnimatePresence initial={false}>
              {openFaq === idx && (
                <motion.div
                  ...
                  className="px-4 sm:px-5 pb-4 text-white/80 text-sm sm:text-base"
                >
                  {f.a}
                </motion.div>
              )}
