...
const Hero = () => {
  return (
    <main id="main" className="pt-28 md:pt-36 relative">
      <section className={`mx-auto max-w-7xl px-6 pb-14 md:pb-24 ${glow}`}>
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="text-center relative z-10">
          ...
          <h1 className="mt-6 text-4xl px-12 md:text-6xl font-extrabold tracking-tight leading-[1.05]">
            Explain, Refactor & <span className="text-purple-400">Elevate</span> Your Code Instantly
          </h1>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a href="#demo" className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/10 text-purple-500 px-5 py-3 text-sm md:text-base hover:bg-white/10 transition">
              Watch Demo
            </a>
          </div>
